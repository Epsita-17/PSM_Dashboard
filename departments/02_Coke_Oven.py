...
# ============================================================
st.set_page_config(
    page_title="PSM Dashboard - Coke Oven",
    page_icon="🔥",
    layout="wide",
...
# IMPORTANT:
# These are the GIDs supplied for the Coke Oven dashboard.
...
def filter_coke_oven(df):
    """
    Filter only Coke Oven records.
...
def load_module(name):
    """Load a module and then apply the Coke Oven filter."""
...
def show_register(title, df, id_names, description_names, status_names):
    ...
    if register_df.empty:
        ...
        st.info("No Coke Oven records found.")
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → Coke Oven</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
...
# Coke Oven — FINAL HORIZONTAL LAYOUT
# ============================================================
            ...
            with st.container(
                ...
                if (
                    ...
                    if not type_counts.empty:
                        ...
                        st.info(
                            "No Coke Oven MOC Type data found."
                        )
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No Coke Oven MOC Category data found."
                        )
        ...
        with moc_register_col:
            ...
            with st.container(
                ...
                if register_df.empty:
                    ...
                    st.info(
                        "No Coke Oven MOC records found."
                    )
...
with c:
    with st.container(
        ...
        if (
            ...
            st.info(
                "No Coke Oven training data found."
            )
