...
# ============================================================
st.set_page_config(
    page_title="PSM Dashboard - Tube Mill",
    page_icon="🔥",
    layout="wide",
...
# IMPORTANT:
# These are the GIDs supplied for the Tube Mill  dashboard.
...
def filter_tube_mill(df):
    """
    Filter only Tube Mill records.
...
def load_module(name):
    """Load a module and then apply the Tube Mill filter."""
    raw = load_google_sheet(SHEETS.get(name))
    return filter_tube_mill(raw)
...
def show_register(title, df, id_names, description_names, status_names):
    ...
    if register_df.empty:
        ...
        st.info("No Tube Mill records found.")
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → Tube Mill</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
...
# TUBE MILL — FINAL HORIZONTAL LAYOUT
# ============================================================
            ...
            with st.container(
                ...
                if (
                    ...
                    if not type_counts.empty:
                        ...
                        st.info(
                            "No TUBE MILL MOC Type data found."
                        )
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No TUBE MILL MOC Category data found."
                        )
        ...
        with moc_register_col:
            ...
            with st.container(
                ...
                if register_df.empty:
                    ...
                    st.info(
                        "No TUBE MILL MOC records found."
                    )
...
with c:
    ...
    with st.container(
        ...
        if (
            ...
            st.info(
                "No Tube Mill training data found."
            )
