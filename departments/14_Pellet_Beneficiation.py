...
# IMPORTANT:
# These are the GIDs supplied for the Pellet & Benification Oven-1 dashboard.
...
def filter_pellet_benification(df):
    """
    Filter only Pellet & Benification records.
...
def load_module(name):
    """Load a module and then apply the Pellet & Benification filter."""
    raw = load_google_sheet(SHEETS.get(name))
    return filter_pellet_benification(raw)
...
def show_register(title, df, id_names, description_names, status_names):
    ...
    if register_df.empty:
        ...
        st.info("No Pellet & Benification records found.")
...
audit = filter_pellet_benification(audit)
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → Pellet & Benification</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
...
# PELLET BENIFICIATION — FINAL HORIZONTAL LAYOUT
# ============================================================
...
with st.container(
        ...
        # ====================================================
        # PELLET BENIFICIATION MOC REGISTER
        # ====================================================
            ...
            with st.container(
                ...
                if (
                    ...
                    if not type_counts.empty:
                        ...
                        st.info(
                            "No PELLET BENIFICIATION MOC Type data found."
                        )
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No PELLET BENIFICIATION MOC Category data found."
                        )
        ...
        with moc_register_col:
            ...
            with st.container(
                ...
                if register_df.empty:
                    ...
                    st.info(
                        "No PELLET BENIFICIATION MOC records found."
                    )
...
with c:
    ...
    with st.container(
        ...
        if (
            ...
            st.info(
                "No Pellet & Benification training data found."
            )
