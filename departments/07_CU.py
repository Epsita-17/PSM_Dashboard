...
def find_status_col(df, candidates=None):
    """Find the actual status column, prioritizing explicit status headers."""
    if df is None or df.empty:
        return None
...
audit = filter_central_utility(audit)
...
# CENTRAL UTILITY — FINAL HORIZONTAL LAYOUT
# ============================================================
            ...
            with st.container(
                ...
                if (
                    ...
                    if not type_counts.empty:
                        ...
                        st.info(
                            "No CENTRAL UTILITY MOC Type data found."
                        )
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No CENTRAL UTILITY MOC Category data found."
                        )
        ...
        with moc_register_col:
            ...
            with st.container(
                ...
                if register_df.empty:
                    ...
                    st.info(
                        "No CENTRAL UTILITY MOC records found."
                    )
