...
# IMPORTANT:
# These are the GIDs supplied for the WRM dashboard.
...
def load_module(name):
    """Load a module and then apply the WRM filter."""
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → WRM</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No WRM MOC Category data found."
                        )
