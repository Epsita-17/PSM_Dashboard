...
# IMPORTANT:
# These are the GIDs supplied for the CSP dashboard.
...
def load_module(name):
    """Load a module and then apply the CSP filter."""
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → CSP</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No CSP MOC Category data found."
                        )
