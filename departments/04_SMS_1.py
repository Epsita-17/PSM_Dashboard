...
# ============================================================
st.set_page_config(
    page_title="PSM Dashboard - SMS-1",
    page_icon="🔥",
    layout="wide",
...
# IMPORTANT:
# These are the GIDs supplied for the SMS-1 dashboard.
...
def load_module(name):
    """Load a module and then apply the SMS-1 filter."""
...
def show_register(title, df, id_names, description_names, status_names):
    ...
    if register_df.empty:
        ...
        st.info("No SMS-1 records found.")
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → SMS-1</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
            ...
            with st.container(
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.info(
                            "No SMS-1 MOC Category data found."
                        )
