...
# IMPORTANT:
# These are the GIDs supplied for the Blast Furnace dashboard.
...
def filter_blast_furnace(df):
    """
    Filter only Blast Furnace records.
...
def load_module(name):
    """Load a module and then apply the Blast Furnace filter."""
...
def show_register(title, df, id_names, description_names, status_names):
    ...
    if register_df.empty:
        ...
        st.info("No Blast Furnace records found.")
...
audit = filter_blast_furnace(audit)
...
st.markdown(
    f"""
    <div class="live-bar">
        <b>LIVE DATA: Google Sheet → Blast Furnace</b>
        &nbsp; | &nbsp;
        Refresh: 5 minutes
        &nbsp; | &nbsp;
...
# BLAST FURNACE — FINAL HORIZONTAL LAYOUT
# ============================================================
                ...
                if (
                    ...
                    if not type_counts.empty:
                        ...
                        st.plotly_chart(
                            ...
                            key="bf_moc_type_donut_final",
                        )

                    else:

                        st.info(
                            "No Blast Furnace MOC Type data found."
                        )
                ...
                if (
                    ...
                    if not category_counts.empty:
                        ...
                        st.plotly_chart(
                            ...
                            key="bf_moc_category_donut_final",
                        )

                    else:

                        st.info(
                            "No Blast Furnace MOC Category data found."
                        )
        ...
        with moc_register_col:
            ...
            with st.container(
                ...
                if register_df.empty:
                    ...
                    st.info(
                        "No Blast Furnace MOC records found."
                    )
...
with c:
    ...
    with st.container(
        ...
        if (
            ...
            st.info(
                "No Blast Furnace training data found."
            )
